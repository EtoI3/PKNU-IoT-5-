...
namespace raspiDisplay
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            await CopyCredentialFileToLocalFolderAsync();
        ...
        // 파이어베이스 로컬 경로 참고
        private async Task CopyCredentialFileToLocalFolderAsync()
        {
            var file = await Windows.Storage.StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Assets/test-325e6-firebase-adminsdk-rnle1-972e67f70a.json"));
            var localFolder = Windows.Storage.ApplicationData.Current.LocalFolder;
            await file.CopyAsync(localFolder, "firebase_credentials.json", Windows.Storage.NameCollisionOption.ReplaceExisting);
        }
    }
}
